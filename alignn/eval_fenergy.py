...
model_path = r"C:\Users\haear\Documents\polytechnique\stage3a\scienti\eval_energy\models\alex_force_1"
relax_file = "CONTCAR"
base_file = "POSCAR"
...
#print(result.stdout.splitlines()[-3:])
...
for i, x in enumerate(name_storage):
